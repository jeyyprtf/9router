...
export default function Header({ onMenuClick, showMenuButton = true }) {
  ...
  return (
    <header className="app-header shrink-0 flex items-center justify-between gap-3 px-4 lg:px-8 pt-3 pb-2 border-b border-border-subtle bg-surface/60 backdrop-blur-xl lg:bg-transparent lg:backdrop-blur-none z-20">
      {/* Mobile menu button */}
      ...
      <div className="flex items-center gap-1 shrink-0">
        ...
        <button
          ...
          className="app-button flex items-center gap-1.5 px-3 h-8 rounded-lg border border-pink-500/30 bg-pink-500/10 text-pink-600 dark:text-pink-400 hover:bg-pink-500/20 transition-colors text-sm font-medium"
  ...
  return (
    <div className="relative w-[160px] sm:w-[220px]">
      ...
      <input
        ...
        className="app-search-input w-full h-8 pl-7 pr-7 rounded-lg border border-border bg-surface/60 text-sm focus:outline-none focus:border-primary/50 transition-colors"
      />
      {query && (
        <button
          type="button"
